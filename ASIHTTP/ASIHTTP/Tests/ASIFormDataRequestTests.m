...
- (void)testPostWithFileUpload
{
	...
	XCTAssertTrue(success,@"Failed to upload the correct data (using local file)");	
	...
	XCTAssertTrue(success,@"Failed to upload the correct data (using NSData)");	
	...
	XCTAssertTrue(success,@"Failed to send the correct content-type / file name");	
...
- (void)testEmptyData
{
	...
	XCTAssertTrue(success,@"Failed to send the correct post data");		
...
- (void)testCharset
{
	...
	XCTAssertTrue(success,@"Failed to correctly encode the data");	
	...
	XCTAssertTrue(success,@"Sent a charset header for an uploaded file");
...
- (void)testPUT
{
	...
	XCTAssertTrue(success,@"Failed to send form data using PUT");
...
- (void)testMultipleValuesForASingleKey
{
	...
	XCTAssertTrue(success,@"Failed to send the correct data");
